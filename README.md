...
* [x] Archecture is MVP
* [x] Using butterknife for view injection
* [x] Using RxJava for aysnc download of the json

## Video Walkthrough

Here's a walkthrough of implemented user stories:

https://github.com/steve1rm/NYTimeSearch/blob/master/screendemo.mp4
...
Retrieving the json from the API. Some values were not consistent when populating the java class using retrofit. Some properties missing and have no value (i.e. heading, multimedia). So compensate I would use some other property as a replacement.
